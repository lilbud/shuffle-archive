...
"Ain't Got You" is more significant than that, however. It introduces one of Bruce's most thematic albums like an overture (which is ironic given its a capella first verse). In fact, had Bruce not recorded "[Tunnel of Love](../1987-01-07_roll-of-the-dice-tunnel-of-love/post.md/)" at the last minute, "Ain't Got You" would have made a fine title track on its own, as every track on the album features characters unable to fully connect.
