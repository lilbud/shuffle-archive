...
I can’t help but suspect the entire chorus is built around answering the question: *What rhymes (ish) with Minneapolis?* But again, it’s a quibble. Minneapolis deserves to be celebrated, and it’s a hard word to rhyme.
...
That first full-band performance helped kick off the opening night of a tour that was never supposed to happen, sparked by a horrific murder that never should have happened, and a heroic response that only could have happened in Minneapolis.
...
**Released:** *Streets of Minneapolis* (single, 2026)<br>
